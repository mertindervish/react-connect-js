...
var ConnectPayments = function ConnectPayments() {
  var _useCreateComponent = useCreateComponent('payments'),
    wrapper = _useCreateComponent.wrapper;
  return wrapper;
};
var ConnectPayouts = function ConnectPayouts() {
  var _useCreateComponent2 = useCreateComponent('payouts'),
    wrapper = _useCreateComponent2.wrapper;
  return wrapper;
};
var ConnectPaymentDetails = function ConnectPaymentDetails(_ref) {
  var chargeId = _ref.chargeId,
...
var ConnectAccountOnboarding = function ConnectAccountOnboarding(_ref2) {
  var onExit = _ref2.onExit,
    recipientTermsOfServiceUrl = _ref2.recipientTermsOfServiceUrl,
    fullTermsOfServiceUrl = _ref2.fullTermsOfServiceUrl,
    privacyPolicyUrl = _ref2.privacyPolicyUrl,
    skipTermsOfServiceCollection = _ref2.skipTermsOfServiceCollection;
  var _useCreateComponent4 = useCreateComponent('account-onboarding'),
    wrapper = _useCreateComponent4.wrapper,
    onboarding = _useCreateComponent4.component;
...
export { ConnectAccountOnboarding, ConnectComponentsProvider, ConnectElementEventNames, ConnectPaymentDetails, ConnectPayments, ConnectPayouts, useAttachAttribute, useAttachEvent, useConnectComponents, useCreateComponent };
